      ...
      <div className="flex min-w-max relative">
        ...
        {diasArray.map((dia) => {
          ...
          <div 
            ...
            key={dia.toISOString()} 
            className={`flex flex-col w-[450px] border-r border-slate-200 shrink-0 z-10 ${isToday ? 'bg-slate-200' : 'bg-transparent'}`}
          >
            ...
            <div className="flex flex-col relative">
              {horas.map(hora => (
                <div key={hora} style={{ height: `${alturaSlot}px` }} className={`border-b border-slate-100 p-1 relative transition-colors group ${isToday ? 'hover:bg-slate-300' : 'hover:bg-slate-50'}`}>
